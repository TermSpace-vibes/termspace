...
| `src/components/Home/HomeView.tsx` | `src/components/Home/WorkspaceCard.tsx`, `src/components/Home/homeHelpers.ts`, `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
| `src/components/Home/WorkspaceCard.tsx` | `src/components/Home/WorkspaceIcon.tsx`, `src/components/Home/homeHelpers.ts`, `src/types/index.ts` |
| `src/components/Home/WorkspaceIcon.tsx` | — |
| `src/components/Home/homeHelpers.ts` | — |
...
| `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` | `src/components/Home/WorkspaceIcon.tsx`, `src/components/Home/homeHelpers.ts`, `src/components/WorkspaceModal/AgentLaunchStep.tsx`, `src/components/WorkspaceModal/workspaceStyleOptions.ts`, `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
| `src/components/WorkspaceSidebar/AddWorkspaceButton.tsx` | — |
| `src/components/WorkspaceSidebar/AgentsSidebarSection.tsx` | `src/store/useAppStore.ts` |
...
| `src/components/WorkspaceSidebar/WorkspaceSidebar.tsx` | `src/components/WorkspaceSidebar/AddWorkspaceButton.tsx`, `src/components/WorkspaceSidebar/AgentsSidebarSection.tsx`, `src/components/WorkspaceSidebar/MediaWidget.tsx`, `src/components/WorkspaceSidebar/ProjectTasks.tsx`, `src/components/WorkspaceSidebar/WorkspaceItem.tsx`, `src/store/useAppStore.ts`, `src/types/index.ts` |
...
| `src/components/WorkspaceView/AgentStudioPane.tsx` | `src/components/WorkspaceView/AgentContextInspector.tsx`, `src/components/WorkspaceView/AgentProviderDiagnostics.tsx`, `src/components/WorkspaceView/ClaudeTerminalInitiator.tsx`, `src/components/WorkspaceView/ProviderIcons.tsx`, `src/components/WorkspaceView/agentTranscript.ts`, `src/components/WorkspaceView/claudeOutputParser.ts`, `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
| `src/components/WorkspaceView/BrowserPane.tsx` | `src/hooks/useBrowserStartupMediaGate.ts`, `src/store/useAppStore.ts`, `src/store/useBrowserMediaStore.ts`, `src/utils/browserPaneTabsState.ts`, `src/utils/sqliteUiState.ts`, `src/utils/tauri.ts` |
...
| `src/components/WorkspaceView/ClaudeTerminalInitiator.tsx` | `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
...
| `src/components/WorkspaceView/TerminalPane.tsx` | `src/components/ConfirmModal/ConfirmModal.tsx`, `src/components/WorkspaceView/ScpUploadOverlay.tsx`, `src/hooks/useGlobalKeybindings.ts`, `src/store/useAppStore.ts`, `src/utils/constants.ts`, `src/utils/tauri.ts` |
...
| `src/components/WorkspaceView/WorkspaceView.tsx` | `src/components/WorkspaceView/SshPortForwardModal.tsx`, `src/components/WorkspaceView/TerminalGrid.tsx`, `src/components/WorkspaceView/ToolingPane.tsx`, `src/components/WorkspaceView/WorkspaceHeader.tsx`, `src/components/WorkspaceView/WorkspaceTabBar.tsx`, `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
| `src/components/WorkspaceView/agentTranscript.ts` | `src/types/index.ts` |
...
| `src/components/ui/DictationButton.tsx` | `src/hooks/useDictation.ts`, `src/store/useAppStore.ts`, `src/utils/constants.ts` |
| `src/components/ui/ErrorBoundary.tsx` | — |
| `src/components/ui/ToastContainer.tsx` | `src/store/useAppStore.ts` |
| `src/hooks/useBrowserMediaBridge.ts` | `src/store/useBrowserMediaStore.ts`, `src/utils/tauri.ts` |
| `src/hooks/useBrowserStartupMediaGate.ts` | `src/utils/tauri.ts` |
...
| `src/hooks/useGlobalTranscription.ts` | `src/hooks/useDictation.ts`, `src/store/useAppStore.ts`, `src/utils/constants.ts` |
...
| `src/store/useAppStore.ts` | `src/store/useBrowserMediaStore.ts`, `src/types/index.ts`, `src/utils/fs.ts`, `src/utils/launchTiling.ts`, `src/utils/layout.ts` |
...
| `src/utils/fs.ts` | — |
| `src/utils/launchTiling.ts` | `src/types/index.ts` |
...
|------|----------------|-------------|
| `src/store/useAppStore.ts` | 39 | `src/App.tsx`, `src/components/CommandPalette/CommandPalette.tsx`, `src/components/EditorPane.tsx`, `src/components/EditorWelcomeScreen.tsx`, `src/components/FileTree.tsx`, `src/components/GitPanel.tsx`, `src/components/Home/HomeView.tsx`, `src/components/MarkdownModal/MarkdownModal.tsx`, `src/components/MarkdownPreview.tsx`, `src/components/SearchPanel.tsx`, `src/components/SettingsModal/SettingsModal.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx`, `src/components/WorkspaceSidebar/AgentsSidebarSection.tsx`, `src/components/WorkspaceSidebar/ProjectTasks.tsx`, `src/components/WorkspaceSidebar/WorkspaceItem.tsx`, `src/components/WorkspaceSidebar/WorkspaceSidebar.tsx`, `src/components/WorkspaceView/AgentStudioPane.tsx`, `src/components/WorkspaceView/BrowserPane.tsx`, `src/components/WorkspaceView/ClaudePane.tsx`, `src/components/WorkspaceView/ClaudeTerminalInitiator.tsx`, `src/components/WorkspaceView/DockerPaneComponent.tsx`, `src/components/WorkspaceView/KubernetesPaneComponent.tsx`, `src/components/WorkspaceView/NativeTerminalPane.tsx`, `src/components/WorkspaceView/ScpUploadOverlay.tsx`, `src/components/WorkspaceView/SshPortForwardModal.tsx`, `src/components/WorkspaceView/TerminalGrid.tsx`, `src/components/WorkspaceView/TerminalPane.tsx`, `src/components/WorkspaceView/ToolingPane.tsx`, `src/components/WorkspaceView/WorkspaceHeader.tsx`, `src/components/WorkspaceView/WorkspaceTabBar.tsx`, `src/components/WorkspaceView/WorkspaceView.tsx`, `src/components/ui/DictationButton.tsx`, `src/components/ui/ToastContainer.tsx`, `src/hooks/useDictation.ts`, `src/hooks/useFileTreeOperations.ts`, `src/hooks/useGlobalKeybindings.ts`, `src/hooks/useGlobalTranscription.ts`, `src/hooks/useNotifications.ts`, `src/hooks/useSqliteUiStateSync.ts` |
| `src/types/index.ts` | 31 | `src/App.tsx`, `src/components/Home/HomeView.tsx`, `src/components/Home/WorkspaceCard.tsx`, `src/components/SettingsModal/SettingsModal.tsx`, `src/components/WorkspaceModal/AgentLaunchStep.tsx`, `src/components/WorkspaceModal/WorkspaceModal.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx`, `src/components/WorkspaceSidebar/MediaWidget.tsx`, `src/components/WorkspaceSidebar/ProjectTasks.tsx`, `src/components/WorkspaceSidebar/WorkspaceItem.tsx`, `src/components/WorkspaceSidebar/WorkspaceSidebar.tsx`, `src/components/WorkspaceView/AgentProviderDiagnostics.tsx`, `src/components/WorkspaceView/AgentStudioPane.tsx`, `src/components/WorkspaceView/ClaudeTerminalInitiator.tsx`, `src/components/WorkspaceView/DockerPaneComponent.tsx`, `src/components/WorkspaceView/KubernetesPaneComponent.tsx`, `src/components/WorkspaceView/ProviderIcons.tsx`, `src/components/WorkspaceView/SshPortForwardModal.tsx`, `src/components/WorkspaceView/TerminalGrid.tsx`, `src/components/WorkspaceView/ToolingPane.tsx`, `src/components/WorkspaceView/WorkspaceHeader.tsx`, `src/components/WorkspaceView/WorkspaceTabBar.tsx`, `src/components/WorkspaceView/WorkspaceView.tsx`, `src/components/WorkspaceView/agentTranscript.ts`, `src/hooks/useFileTreeOperations.ts`, `src/hooks/useGlobalKeybindings.ts`, `src/hooks/useNotifications.ts`, `src/store/useAppStore.ts`, `src/store/useBrowserMediaStore.ts`, `src/utils/launchTiling.ts`, `src/utils/layout.ts` |
| `src/utils/tauri.ts` | 22 | `src/App.tsx`, `src/components/Home/HomeView.tsx`, `src/components/SettingsModal/SettingsModal.tsx`, `src/components/WorkspaceModal/AgentLaunchStep.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx`, `src/components/WorkspaceSidebar/MediaWidget.tsx`, `src/components/WorkspaceView/AgentStudioPane.tsx`, `src/components/WorkspaceView/BrowserPane.tsx`, `src/components/WorkspaceView/ClaudePane.tsx`, `src/components/WorkspaceView/ClaudeTerminalInitiator.tsx`, `src/components/WorkspaceView/NativeTerminalPane.tsx`, `src/components/WorkspaceView/ScpUploadOverlay.tsx`, `src/components/WorkspaceView/SshPortForwardModal.tsx`, `src/components/WorkspaceView/TerminalPane.tsx`, `src/components/WorkspaceView/ToolingPane.tsx`, `src/components/WorkspaceView/WorkspaceView.tsx`, `src/hooks/useBrowserMediaBridge.ts`, `src/hooks/useBrowserStartupMediaGate.ts`, `src/hooks/useFileTreeOperations.ts`, `src/hooks/useGlobalKeybindings.ts`, `src/hooks/useNotifications.ts`, `src/utils/sqliteUiState.ts` |
...
| `src/utils/constants.ts` | 4 | `src/components/WorkspaceView/NativeTerminalPane.tsx`, `src/components/WorkspaceView/TerminalPane.tsx`, `src/components/ui/DictationButton.tsx`, `src/hooks/useGlobalTranscription.ts` |
| `src/utils/fs.ts` | 4 | `src/components/EditorPane.tsx`, `src/components/FileTree.tsx`, `src/components/MarkdownModal/MarkdownModal.tsx`, `src/store/useAppStore.ts` |
| `src/components/Home/homeHelpers.ts` | 3 | `src/components/Home/HomeView.tsx`, `src/components/Home/WorkspaceCard.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` |
| `src/components/WorkspaceView/AgentStudioPane.tsx` | 3 | `src/components/WorkspaceModal/AgentLaunchStep.tsx`, `src/components/WorkspaceView/AgentProviderDiagnostics.tsx`, `src/components/WorkspaceView/TerminalGrid.tsx` |
| `src/components/WorkspaceView/claudeOutputParser.ts` | 3 | `src/components/WorkspaceView/AgentStudioPane.tsx`, `src/components/WorkspaceView/ClaudePane.tsx`, `src/components/WorkspaceView/claudeTranscript.ts` |
...
| `src/components/Home/WorkspaceIcon.tsx` | 2 | `src/components/Home/WorkspaceCard.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` |
| `src/components/MarkdownPreview.tsx` | 2 | `src/components/EditorPane.tsx`, `src/components/MarkdownModal/MarkdownModal.tsx` |
| `src/components/WorkspaceModal/AgentLaunchStep.tsx` | 2 | `src/components/WorkspaceModal/WorkspaceModal.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` |
| `src/components/WorkspaceModal/workspaceStyleOptions.ts` | 2 | `src/components/WorkspaceModal/WorkspaceModal.tsx`, `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` |
| `src/components/WorkspaceView/AgentProviderDiagnostics.tsx` | 2 | `src/components/WorkspaceModal/AgentLaunchStep.tsx`, `src/components/WorkspaceView/AgentStudioPane.tsx` |
...
| `src/components/WorkspaceView/ScpUploadOverlay.tsx` | 2 | `src/components/WorkspaceView/NativeTerminalPane.tsx`, `src/components/WorkspaceView/TerminalPane.tsx` |
...
| `src/hooks/useDictation.ts` | 2 | `src/components/ui/DictationButton.tsx`, `src/hooks/useGlobalTranscription.ts` |
...
| `src/components/Home/WorkspaceCard.tsx` | 1 | `src/components/Home/HomeView.tsx` |
...
| `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` | 1 | `src/App.tsx` |
| `src/components/WorkspaceSidebar/AddWorkspaceButton.tsx` | 1 | `src/components/WorkspaceSidebar/WorkspaceSidebar.tsx` |
| `src/components/WorkspaceSidebar/AgentsSidebarSection.tsx` | 1 | `src/components/WorkspaceSidebar/WorkspaceSidebar.tsx` |
...
| `src/components/WorkspaceView/ClaudeTerminalInitiator.tsx` | 1 | `src/components/WorkspaceView/AgentStudioPane.tsx` |
...
| `src/components/WorkspaceView/SshPortForwardModal.tsx` | 1 | `src/components/WorkspaceView/WorkspaceView.tsx` |
...
| `src/components/WorkspaceView/agentTranscript.ts` | 1 | `src/components/WorkspaceView/AgentStudioPane.tsx` |
...
| `src/hooks/useBrowserStartupMediaGate.ts` | 1 | `src/components/WorkspaceView/BrowserPane.tsx` |
...
| `src/utils/launchTiling.ts` | 1 | `src/store/useAppStore.ts` |
...
- `src/store/useAppStore.ts` — **39 dependents**
- `src/types/index.ts` — **31 dependents**
- `src/utils/tauri.ts` — **22 dependents**
...
- `src/utils/constants.ts` — **4 dependents**
- `src/utils/fs.ts` — **4 dependents**
- `src/components/Home/homeHelpers.ts` — **3 dependents**
- `src/components/WorkspaceView/AgentStudioPane.tsx` — **3 dependents**
- `src/components/WorkspaceView/claudeOutputParser.ts` — **3 dependents**
