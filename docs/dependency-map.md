...
| `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` | `src/components/WorkspaceModal/AgentLaunchStep.tsx`, `src/components/WorkspaceModal/workspaceStyleOptions.ts`, `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
...
| `src/components/Home/homeHelpers.ts` | 2 | `src/components/Home/HomeView.tsx`, `src/components/Home/WorkspaceCard.tsx` |
...
| `src/components/Home/WorkspaceIcon.tsx` | 1 | `src/components/Home/WorkspaceCard.tsx` |
...
- `src/store/useAppStore.ts` — **35 dependents**
- `src/types/index.ts` — **29 dependents**
- `src/utils/tauri.ts` — **19 dependents**
