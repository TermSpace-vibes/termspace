...
| `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` | `src/components/WorkspaceModal/workspaceStyleOptions.ts`, `src/store/useAppStore.ts`, `src/types/index.ts`, `src/utils/tauri.ts` |
...
| `src/components/WorkspaceSetup/WorkspaceSetupView.tsx` | 0 | — |
