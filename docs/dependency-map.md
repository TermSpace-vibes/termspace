...
| `src/components/Home/HomeView.tsx` | `src/types/index.ts` |
...
- `src/store/useAppStore.ts` — **34 dependents**
- `src/types/index.ts` — **28 dependents**
- `src/utils/tauri.ts` — **18 dependents**
